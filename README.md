...
###Prerequisites
Libraries needed to run the project can be found in /app/requirements file

Most notably, the project requires 
...
For the user input predictions, a default genre 'XX' is provided to the model.
